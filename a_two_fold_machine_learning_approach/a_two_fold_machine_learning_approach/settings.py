...
ROOT_URLCONF = 'a_two_fold_machine_learning_approach.urls'
...
WSGI_APPLICATION = 'a_two_fold_machine_learning_approach.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'a_two_fold_machine_learning_approach',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
